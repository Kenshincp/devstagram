...
@section('contenido')
    <div class="md:flex md:justify-center">
        <div class="md:w-6/12">
            <img src="{{ asset('img/register-img.webp') }}" class="md:felx md:justify-center md:gap-4 md:items-center" alt="">
        </div>
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" placeholder="Ingresa tu nombre" class="border p-3 w-full rounded-lg @error('name')
                        border-red-500
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="username" name="username" placeholder="Ingresa tu nombre de usuario" class="border p-3 w-full rounded-lg @error('username')
                    border-red-500
                @enderror" value="{{ old('usermane') }}">
